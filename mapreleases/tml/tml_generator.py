...
from mapreleases.tml.items import TileLayer
from mapreleases.tml.tml import Teemap
...
class TmlGenerator(object):
    def add(self, result, tiles, layer):
        if layer:
    ...
    def generate(self, map_path, result_path):
        t = Teemap(map_path)
        result = {}
        ...
        self.add(result, gameTiles, t.gamelayer)
        self.add(result, frontTiles, frontlayer)
